...
$(document).ready(function() {
    ...
    $("#test").click(function() {
        pomelo.init({
            ...
            var route = 'comm.commHandler.verifyCode';
            pomelo.request(route,{phone:'13738189424'},function (data) {
	...
	$("#entry").keypress(function(e) {
		...
		if(msg == 'test'){
            var route = 'comm.commHandler.verifyCode';
            console.log('send request ',route)
            pomelo.request(route,{phone:'13738189724'},function (data) {
                console.log('data',data)
            })
        }else if(!util.isBlank(msg)) {
